...
import '../entity/activity_model.dart';
import '../entity/destination_model.dart';
    ...
    return Stack(
      children: [
        Container(
          ...
          child: Hero(
            tag: widget.destination.image.toString(),
            child: ClipRRect(
              borderRadius: BorderRadius.circular(30.0),
              child: Image(
                image: AssetImage(widget.destination.image.toString()),
                fit: BoxFit.cover,
              ),
            ),
          ),
